...
{\normalsize \textbf{PROF. ASHWINI UTTURE}}\\[0.3cm]
{\normalsize DEPARTMENT OF COMPUTER ENGINEERING (NBA ACCREDITED)}\\[0.8cm]

\includegraphics[width=0.25\textwidth]{nmiet_logo.png}\\[0.8cm]

{\large \textbf{NUTAN MAHARASHTRA INSTITUTE OF ENGINEERING \&}\\
\textbf{TECHNOLOGY}}\\
{\normalsize TALEGAON DABHADE TAL. MAVAL, PUNE, 410507}\\
...
\noindent This is to certify that, \textbf{Aditya Shailesh Bharate (TEC C-101)} have successfully 
completed the Internship in Eduskills Foundation as ``{AWS AI-POWERED CLOUD ENGINEER}'' 
under my supervision, in the partial fulfilment of Third Year in Computer 
Engineering of Savitribai Phule Pune University (SPPU).

\vspace{2cm}
\noindent Date: 21/04/2026 \hfill Place: Pune
...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}ccc}
    ...
    Internship Guide & Internship Coordinator & Head Of Department
\end{tabular*}
...
I thank our Internship guide \textbf{\textit{Prof. Ashwini Utture}}, for her exceptional support, 
...
I would like to express my gratitude to our Internship coordinator \textbf{\textit{Prof. Nilesh Kamble}} 
...
I express our heartily gratitude towards \textbf{\textit{Dr. Rahul Patil}}, Head of Department of 
...
With deep sense of gratitude, I thank our Director \textbf{\textit{Dr. Pramod Patil}}
...
resources throughout this Internship. 
...
The organizational structure of Eduskill Foundation follows a hierarchical model with 
top management overseeing strategic decisions and departments such as development, 
data science, and operations handling execution. Team leads guide developers and 
interns in project tasks, ensuring efficient workflow and collaboration within the 
organization.
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.90\textwidth, height=0.45\textheight, keepaspectratio]{architecture_diagram.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.90\textwidth, height=0.55\textheight, keepaspectratio]{ec2_creation.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth, height=0.75\textheight, keepaspectratio]{lambda_code.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth, height=0.75\textheight, keepaspectratio]{ec2_instance.png}
